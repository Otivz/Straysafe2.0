...
export default function SubdReportModal({ isOpen, onClose, onSuccess }: SubdReportModalProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        custodyStatus: 'Sighting' as 'Sighting' | 'Secured',
        securedLocationMode: 'with_animal' as 'with_animal' | 'secured_elsewhere',
        mediaFiles: [] as File[],
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-300">
                ...
                <div id="subd-modal-scroll-body" className="p-6 sm:p-8 overflow-y-auto custom-scrollbar flex-1 bg-white">
                    ...
                    {currentStep === 6 && (
                        <div className="space-y-6">
                            <div>
                                <h2 className="text-xl font-black text-[#1a1208] uppercase tracking-tight flex items-center gap-2">
                                    <span>Location & Custody Status</span>
                                    <span className="text-red-500 text-sm">*</span>
                                </h2>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[11px] font-semibold text-gray-500 mt-1.5 leading-relaxed">
                                            Sighting only. Provide where the animal was observed.
                                        </p>
                                    </div>
                                </button>
                                ...
                                >
                                    ...
                                    <div>
                                        <span className="text-[10px] font-black uppercase tracking-wider text-emerald-600 block">Option B</span>
                                        <h3 className="text-sm font-black text-[#1a1208] mt-0.5 leading-snug">
                                            I found the animal and secured it in a safe place
                                        </h3>
                                        <p className="text-[11px] font-semibold text-gray-500 mt-1.5 leading-relaxed">
                                            In custody. You currently have physical custody or shelter for the animal.
                                        </p>
                                    </div>
                                </button>
                            </div>
                            ...
                            <div>
                                <label className="text-xs font-black text-[#1a1208] uppercase tracking-wider mb-2 block">
                                ...
                                <input
                                    ...
                                    placeholder={
                                        formData.custodyStatus === 'Secured'
                                            ? "e.g. Inside front gate at Phase 2 Lot 8, or kept on porch"
                                            : "Near Barangay Hall, beside basketball court, etc."
                                    }
            ...
            <AnimalLoadingOverlay
                ...
                message={
                    uploadProgress !== null
                        ? `Uploading Media Evidence (${uploadProgress}%)`
                        : 'Submitting Stray Report'
                }
                subMessage={
                    uploadProgress !== null
                        ? uploadProgress < 100
                            ? 'Uploading high-resolution photos securely to Cloudinary storage...'
                            : 'Finalizing evidence registration and alerting responders...'
                        : 'Saving location coordinates, registering stray report, and dispatching to responders...'
                }
                progressText={
                    uploadProgress !== null
                        ? `${uploadProgress}% Upload Completed`
                        : 'Processing stray report dispatch...'
                }
                showProgressBar={true}
            />
