    ...
    const getTimelineData = () => {
        ...
        if (report.status_id === 3) {
            ...
            steps.push({
                ...
                note: rejectedHistory?.remarks || 'Request was rejected by the Barangay.'
            });
            return steps;
        }

        // 1. Rescue Team Assigned (first Barangay action)
        ...
        steps.push({
            ...
            note: isInProgress ? `Barangay rescue squad dispatched and on-site at ${report.landmark || 'Incident Location'}.` : '-'
        });
                ...
                <BrgyNavbar
                    leftContent={
                        <div className="flex items-center gap-4">
                            <Link to="/brgy/history" className="w-9 h-9 rounded-full border border-gray-200 flex items-center justify-center text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-all shrink-0">
                    ...
                    <div className="max-w-7xl mx-auto">
                        {loading ? (
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="block md:hidden relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#334155] via-[#475569] to-[#64748B] p-5 shadow-lg shadow-slate-900/10 text-white animate-in fade-in slide-in-from-top-3 duration-300">
                                    {/* Decorative glowing backdrops */}
                                    <div className="absolute -right-8 -top-8 w-36 h-36 bg-white/10 rounded-full blur-2xl pointer-events-none" />
                                    <div className="absolute right-10 -bottom-8 w-32 h-32 bg-slate-300/20 rounded-full blur-xl pointer-events-none" />
                                    ...
                                    <div className="relative z-10 space-y-3.5">
                                        <div className="flex items-center justify-between gap-2">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <div>
                                                    <div className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-white/20 backdrop-blur-md text-[10px] font-black uppercase tracking-wider text-slate-200 border border-white/25 shadow-2xs mb-0.5">
                                                        <Sparkles className="w-2.5 h-2.5 text-amber-200" /> Archived Incident
                                                    </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-2 pt-0.5">
                                            <div className="bg-white/15 backdrop-blur-md p-2.5 rounded-2xl border border-white/30 flex items-center gap-2 shadow-2xs">
                                                ...
                                                <div className="min-w-0">
                                                    <div className="text-[9px] font-extrabold text-slate-300 uppercase tracking-wider truncate">Status</div>
                                                    <div className="text-xs font-black text-white leading-tight truncate">{statusMap[report.status_id] || 'Resolved'}</div>
                                                </div>
                                            </div>
                                            <div className="bg-white/15 backdrop-blur-md p-2.5 rounded-2xl border border-white/30 flex items-center gap-2 shadow-2xs">
                                                <MapPin className="w-3.5 h-3.5 text-amber-200 shrink-0" />
                                                <div className="min-w-0">
                                                    <div className="text-[9px] font-extrabold text-slate-300 uppercase tracking-wider truncate">Location</div>
                                                    <div className="text-xs font-black text-white leading-tight truncate">{report.landmark || 'Incident Area'}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="pl-1">
                                                {timeline.map((step, idx) => {
                                                    ...
                                                    if (isCompleted) {
                                                        circleBg = 'bg-orange-600 text-white border-orange-600 shadow-lg shadow-purple-500/25';
                                                            ...
                                                            <div className="ml-3.5 flex-1">
                                                                ...
                                                                {isActive && (
                                                                    <button
                                                                        ...
                                                                        className="mt-2.5 flex items-center gap-1 text-[9px] font-black text-orange-600 hover:text-orange-700 uppercase tracking-wider transition-colors"
                                                                    >
                                                                ...
                                                                {isActive && isExpanded && stepDetail && (
                                                                    <div className="mt-3 rounded-2xl border border-gray-100 bg-gray-50/60 overflow-hidden animate-in slide-in-from-top-2 duration-200">
                                                                        ...
                                                                        <div className="px-4 py-2.5 border-b border-gray-100">
                                                                            ...
                                                                            <span className="inline-flex px-2 py-0.5 rounded-md text-[9px] font-black bg-orange-50 text-orange-600 border border-orange-100 uppercase tracking-wide">
                                                                                    ...
                                                                                    {stepDetail.media.map((mediaFile: any, mi: number) => {
                                                                                        ...
                                                                                        return (
                                                                                            <div
                                                                                                ...
                                                                                                className="relative w-12 h-12 rounded-lg overflow-hidden border border-gray-100 shadow-sm cursor-pointer hover:border-orange-500 transition-all bg-black flex items-center justify-center group shrink-0"
                                                                                            >
                                                                                                {isVideo ? (
...
export default BrgyViewHistory;
