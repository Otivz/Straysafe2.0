                ...
                <SubdNavbar
                    leftContent={
                        <div className="flex flex-col">
                            <h1 className="text-xl font-black text-gray-900 tracking-tight leading-none">Account Profile</h1>
                            <p className="text-[11px] text-gray-400 font-semibold mt-1.5 leading-none">View and manage your subdivision leader user information</p>
                        </div>
                    }
                />
                                ...
                                <div className="bg-white border border-gray-100 shadow-xl rounded-[2.5rem] p-8 flex flex-col items-center text-center relative overflow-hidden group">
                                    ...
                                    <div className="relative w-32 h-32 rounded-full border-4 border-gray-50 shadow-inner overflow-hidden mb-6 group/avatar bg-gray-100 flex items-center justify-center">
                                        ...
                                        {user?.profile_picture ? (
                                            ...
                                            <div className="w-full h-full bg-gradient-to-br from-orange-400 to-[#B35D25] text-white flex items-center justify-center font-black text-4xl uppercase select-none">
